...
The Data Specification on Statistical Units – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Statistical Units.

The specification specifies the following conformance classes:

| Conformance class | Standardization target |
| ----------------- | ---------------------- |
| [GML application schemas, Statistical Units](http://inspire.ec.europa.eu/id/ats/data-su/3.0/su-gml) | INSPIRE spatial data set encoded in GML, Statistical Units features |
| [Application Schema, Statistical Units Base](http://inspire.ec.europa.eu/id/ats/data-su/3.0/su-as) | INSPIRE spatial data set |
| [Application Schema, Statistical Units Grid](http://inspire.ec.europa.eu/id/ats/data-su/3.0/su-grid-as) | INSPIRE spatial data set |
| [Application Schema, Statistical Units Vector](http://inspire.ec.europa.eu/id/ats/data-su/3.0/su-vector-as) | INSPIRE spatial data set |
| [Reference Systems, Statistical Units](http://inspire.ec.europa.eu/id/ats/data-su/3.0/su-rs) | INSPIRE spatial data set |
| [Data Consistency, Statistical Units](http://inspire.ec.europa.eu/id/ats/data-su/3.0/su-dc) | INSPIRE spatial data set |
| [Information Accessibility, Statistical Units](http://inspire.ec.europa.eu/id/ats/data-su/3.0/su-ia) | INSPIRE spatial data set |
| [Portrayal, Statistical Units](http://inspire.ec.europa.eu/id/ats/data-su/3.0/su-portrayal) | INSPIRE view service |
...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Statistical Units - Core", are not needed as no feature instance can be of a type from that application schema.
